...
const SHOP_ITEMS = [
  { id: 'orb',    name: 'Сфера ловли',  price: 80,  desc: 'Для поимки диких монстриков.' },
  ...
  { id: 'ether',  name: 'Эфир',         price: 250, desc: 'Восполняет все ПП умений одного монстрика.' },
  { id: 'scroll', name: 'Свиток умения', price: 400, desc: 'Случайное умение — научи любого монстрика.' },
  { id: 'rod',    name: 'Удочка',       price: 600, desc: 'Рыбачь у воды клавишей F. Покупается один раз.' },
  { id: 'stone',  name: 'Камень эволюции', price: 1500, desc: 'Мгновенно эволюционирует монстрика.' },
